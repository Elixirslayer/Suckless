...
static const Key keys[] = {
    ...
    { MODKEY,    	                XK_Print,  spawn,          {.v = (const char*[]){"zsh", "/home/oc/Scripts/screenshot-selection.zsh", NULL}} },
    { 0,		                    XK_Print,  spawn,          {.v = (const char*[]){"zsh", "/home/oc/Scripts/screenshot-full.zsh", NULL}} }, 
    { Mod4Mask,                     XK_c,      spawn,          SHCMD("/home/oc/Scripts/clip.sh add") }, 
    { Mod4Mask,                     XK_v,      spawn,          SHCMD("/home/oc/Scripts/clip.sh sel") }, 
    { Mod4Mask,                     XK_r,      spawn,          SHCMD("/home/oc/Scripts/record") }, 
    ...
    { 0|ShiftMask,              XK_F1,  spawn, SHCMD("~/Suckless/dmenu/Scripts/dmenu_audioswitch") },
	{ 0|ShiftMask,              XK_F2,  spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -5% && pkill -RTMIN+10 -f 'dwmblocks'") },
	{ 0|ShiftMask,              XK_F3,  spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5% && pkill -RTMIN+10 -f 'dwmblocks'") },
    { 0|ShiftMask,              XK_F4,  spawn, SHCMD("/home/oc/Scripts/media-play-pause.zsh") },
    { 0|ShiftMask,              XK_F5,  spawn, SHCMD("/home/oc/Scripts/media-previous.zsh") },
