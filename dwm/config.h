...
static const Key keys[] = {
    ...
    { Mod4Mask|ShiftMask,           XK_f,      spawn,          SHCMD("librewolf") }, 
    { Mod4Mask,                     XK_f,      spawn,          SHCMD("zen-browser") }, 
    ...
    { 0|ShiftMask,              XK_F2,  spawn, SHCMD("/home/oc/Scripts/media-play-pause.zsh") },
    { 0|ShiftMask,              XK_F3,  spawn, SHCMD("/home/oc/Scripts/media-next.zsh") },
    { 0|ShiftMask,              XK_F4,  spawn, SHCMD("/home/oc/Scripts/media-previous.zsh") },
    { 0|ShiftMask,              XK_F5,  spawn, SHCMD("/home/oc/Scripts/media-stop.zsh") },
    { 0|ShiftMask,              XK_F6,  spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5% && pkill -RTMIN+10 -f 'dwmblocks'") },
    { 0|ShiftMask,              XK_F7,  spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -5% && pkill -RTMIN+10 -f 'dwmblocks'") },
